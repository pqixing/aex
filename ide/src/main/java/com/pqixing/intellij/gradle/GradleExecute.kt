...
object GradleExecute {
    ...
    private fun executeByInvoker(project: Project, req: GradleRequest, callBack: (r: GradleResult) -> Unit) {
        ...
        val listener =
            GradleTaskListener(invoker.createBuildTaskListener(request, req.tasks.firstOrNull()), project, callBack)
    ...
    private fun executeTasksByDefault(project: Project, req: GradleRequest, callBack: (r: GradleResult) -> Unit) {
        ...
        val listener = GradleTaskListener(GradleCompatListener.createTaskListener(project, taskId, req.tasks.firstOrNull()), project, callBack)
